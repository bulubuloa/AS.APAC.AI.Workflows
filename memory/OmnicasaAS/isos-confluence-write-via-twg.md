...
Part 0 (setup kit) page `6838812674`, step-by-step Setup guide `6837862577` (child of Part 0). The kit itself: `OmnicasaAS/ai-workspace` (git; memory dirs for OmnicasaAS/ABCB/ABMB are symlinks into `ai-workspace/memory/`, task files in `ai-workspace/issues/`). At the end of a ticket: commit the memory + issues changes there.
