...
Analyse the task described in $1 and append an `## Analysis` section to it. This step is **read-only**: do not edit code, do not run any SQL other than SELECT, do not transition or comment on the ticket. Output is text in the task file.
...
Read $1 and every Confluence page it links. Restate the goal in one sentence and list what you will need to verify.
