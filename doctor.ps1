...
if ($acct -eq '739075353953') { OK 'AWS account 739075353953' } else { Bad 'AWS credentials (aws login --region ap-southeast-1, or aws configure with an access key) - expected account 739075353953' }
